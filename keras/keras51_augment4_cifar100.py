...
augment_count = 40000 # 2만개

 # randint()  중복이 생길 수 있음 중복없는 랜덤을 추출하려면 choice()를 사용하고 옵션으로 replace를 False로줘야함
randidx = np.random.choice(x_train.shape[0], size=augment_count, replace=False) # int형으로 랜덤으로 추출한다
