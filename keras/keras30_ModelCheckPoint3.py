...
"""
keras30_ModelCheckPoint2.py 복사 해옴
...
# print(date) # 2026-09-14 11:40:56.797997
# print(type(date)) # <class 'datetime.datetime'>

date = date.strftime("%m%d_%H%M") # strftime > String for Time / 0914_1146
# print(date) # 0914_1153
# print(type(date)) # <class 'str'>

filename = "{epoch:04d}-{val_loss:.4f}.keras" # fix.history에서 땡겨온다 
# 04d >  4자리의 정수 / 4f > 4자리의 소수점 자리
filepath = "".join([model_path, "k30_", date, "_", filename]) # 문자를 합치겠다 join함수 리스트를 합친다
# print(filepath) # ./_save/keras30/k30_0914_1153_{epoch:04d}-{val_loss:4f}.keras
############### mcp 세이브 파일명 만들기 끝 ####################
...
#4. 평가 예측
print("================= keras30_ModelCheckPoint3 ================")
